...
<body class="hold-transition sidebar-mini layout-fixed">
                        ...
                        <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                            <form>
                                <div class="flex justify-between items-center">
                                    ...
                                    <p class="italic text-red-600 text-sm"><span class="text-[18px]">*</span> Wajib diisi</p>
                                </div>
                                <div class="flex flex-wrap">
                                    <div class="w-full lg:w-6/12 px-4">
                                        <div class="relative w-full mb-3">
                                            <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" htmlfor="grid-password">
                                                <span class="text-[16px]">*</span> Nama Lengkap
                                            </label>
                                    ...
                                    <div class="w-full lg:w-6/12 px-4">
                                        <div class="relative w-full mb-3">
                                            <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" htmlfor="grid-password">
                                                <span class="text-[16px]">*</span> Nomor Induk Kependudukan (NIK) Siswa
                                            </label>
                                    ...
                                    <div class="w-full lg:w-6/12 px-4">
                                        <div class="relative w-full mb-3">
                                            <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" htmlfor="grid-password">
                                                <span class="text-[16px]">*</span> Tempat / Tanggal Lahir
                                            </label>
    ...
    <div class="w-full lg:w-6/12 px-4">
        <div class="relative w-full mb-3">
            ...
            <input type="text" id="nik_ortu_wali" name="nik_ortu_wali"
    ...
    <div class="w-full lg:w-6/12 px-4">
        <div class="relative w-full mb-3">
            <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" htmlfor="grid-password">
                <span class="text-[16px]">*</span> Nama Orangtua / Wali
            </label>
    ...
    <div class="w-full lg:w-6/12 px-4">
        <div class="relative w-full mb-3">
            <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" htmlfor="grid-password">
                <span class="text-[16px]">*</span> Nomor HP/WA
            </label>
    ...
    <div class="w-full lg:w-6/12 px-4">
        <div class="relative w-full mb-3">
            <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" htmlfor="grid-password">
                <span class="text-[16px]">*</span> Umur
            </label>
    ...
    <div class="w-full lg:w-6/12 px-4">
        <div class="relative w-full mb-3">
            <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" htmlfor="grid-password">
                <span class="text-[16px]">*</span> Nama Sekolah
            </label>
    ...
    <div class="w-full lg:w-6/12 px-4">
        <div class="relative w-full mb-3">
            <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" htmlfor="grid-password">
                <span class="text-[16px]">*</span> Alamat Sekolah
            </label>
    ...
    <div class="w-full lg:w-6/12 px-4">
        <div class="relative w-full mb-3">
            <label for="puskesmas" class="block uppercase text-gray-600 text-xs font-bold mb-2">
                <span class="text-[16px]">*</span> Puskesmas
            </label>
    ...
    <div class="w-full lg:w-6/12 px-4">
        <div class="relative w-full mb-3">
            <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" htmlfor="grid-password">
                <span class="text-[16px]">*</span> Kelas
            </label>
            <input type="number" id="kelas" name="kelas" max="12"
                class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">
            <p class="text-sm italic text-[#94a3b8]">Kelas 1 - 12</p>
        </div>
    </div>
    <div class="w-full lg:w-6/12 px-4">
        <div class="relative w-full mb-3">
            <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2">
                <span class="text-[16px]">*</span> Jenis Kelamin
            </label>
    ...
    <div class="w-full lg:w-6/12 px-4">
        <div class="relative w-full mb-3">
            <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2">
                <span class="text-[16px]">*</span> Golongan Darah
            </label>
            <div class="flex space-x-4 mt-2">
                <label class="inline-flex items-center">
                ...
                <label class="inline-flex items-center">
                    <input type="radio" id="golongan_darah" name="golongan_darah" value="-"
                        class="form-radio text-pink-500">
    ...
    <div class="flex flex-wrap">
        <div class="w-full lg:w-6/12 px-4">
            <div class="relative w-full mb-3">
                <label class="block uppercase text-gray-600 text-xs font-bold mb-2"><span class="text-[16px]">*</span>
                    Provinsi</label>
        ...
        <div class="w-full lg:w-12/12 px-4">
            <div class="relative w-full mb-3">
                <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" htmlfor="grid-password">
                    <span class="text-[16px]">*</span> Alamat
                </label>
    ...
    <h6 class="text-blueGray-400 text-sm mt-3 mb-6 font-bold uppercase">Alamat Domisili / Tinggal Peserta Didik</h6>

    <div class="mb-4 px-4">
        <label class="inline-flex items-center">
            <input type="checkbox" name="alamat_sesuai_kk" id="checkbox-alamat-sesuai"
                class="form-checkbox text-pink-500">
            <span class="ml-2 text-sm font-semibold">Alamat domisili / tinggal sesuai dengan alamat KK atau KTP</span>
        </label>
    </div>
    ...
    <div class="flex flex-wrap">
        <div class="w-full lg:w-12/12 px-4">
            <div class="relative w-full mb-3">
                <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2">
                    <span class="text-[16px]">*</span> Jenis Disabilitas
                </label>
                <div class="flex flex-col space-y-2 mt-2">
                    <!-- Checkbox "Tidak Ada" -->
                    <label class="inline-flex items-center">
                        <input type="checkbox" id="disabilitas_tidak_ada" name="jenis_disabilitas[]"
                            value="Tidak Ada" class="form-checkbox text-pink-500"
                            onchange="toggleDisabilitasTidakAda(this)">
                ...
                <script>
                    function toggleDisabilitasTidakAda(checkbox) {
                        const lain = document.querySelectorAll('.disabilitas_lain');
                        if (checkbox.checked) {
                            lain.forEach(cb => cb.checked = false);
                        }
                    }
...
disabled:pointer-events-none sm:ml-3 sm:w-auto transition">
        ...
        <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            <div id="cekModalContent"
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <hr class="mb-3">
                    <h3 class="text-lg font-semibold mb-2">Alamat Peserta Didik Domisili / Tinggal</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 space-y-3 px-2">
                        <div>
                            <p class="font-semibold">Provinsi Domisili / Tinggal</p>
                            <p id="output_provinsi_dom"></p>
                        </div>
                        <div>
                            <p class="font-semibold">Kota / Kabupaten Domisili / Tinggal</p>
                            <p id="output_kota_dom"></p>
                        </div>
                        <div>
                            <p class="font-semibold">Kecamatan Domisili / Tinggal</p>
                            <p id="output_kecamatan_dom"></p>
                        </div>
                        <div>
                            <p class="font-semibold">Kelurahan Domisili / Tinggal</p>
                            <p id="output_kelurahan_dom"></p>
                        </div>
                        <div>
                            <p class="font-semibold">Alamat Domisili / Tinggal</p>
    ...
    <div id="invalid-modal"
        class="fixed inset-0 bg-black/30 flex items-center justify-center z-50 hidden transition-opacity duration-300">
        <div class="bg-white rounded-lg shadow-lg p-6 max-w-md w-full">
            ...
            <div class="flex justify-end">
                <button onclick="hideInvalidModal()"
        ...
        $(document).ready(function() {
            ...
            $("#nama_sekolah").autocomplete({
                ...
                select: function(event, ui) {
                    ...
                    const puskesmas = ui.item.nama_puskesmas;
                    ...
                    if (optionExists) {
                        ...
                        localStorage.setItem('nama_puskesmas', ui.item.nama_puskesmas ?? '');
                    } else {
    ...
    <script>
        ...
        function openModal() {
            ...
            if (!isDataValid) {
                ...
                document.getElementById('judul-modal-message').textContent = `Gagal Selanjutnya`;
                // Isi pesan modal
                const listItems = invalidFieldsFormatted.split(', ').map(field => `<li>${field} Wajib diisi</li>`);
                document.getElementById('invalid-modal-message').innerHTML =
                    `<ul class="">${listItems.join('')} </ul>`;
        ...
        function showInvalidModal(judul, pesan) {
            const modal = document.getElementById('invalid-modal');
            const title = document.getElementById('judul-modal-message');
            const message = document.getElementById('invalid-modal-message');

            title.textContent = judul;
            message.textContent = pesan;

            modal.classList.remove('hidden');
            modal.classList.add('opacity-0'); // mulai dari transparan
        ...
        function showAlert(title, message, redirect = false, successRedirect = false, nik = null) {
            ...
            if (successRedirect) {
                button.addEventListener('click', () => {
                    window.location.href = `/pkg_sekolah/tidak_setuju?nik=${nik}`;
                });
                // console.log("sukses run")
            } else if (redirect) {
