                                ...
                                <div class="flex flex-wrap">
                                    ...
                                    <div class="w-full lg:w-6/12 px-4">
                                        <div class="relative w-full mb-3">
                                            ...
                                            <input type="text" id="nik_ortu_wali" name="nik_ortu_wali" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">
                                        </div>
                                    </div>
                                    <div class="w-full lg:w-6/12 px-4">
                                        <div class="relative w-full mb-3">
                                    ...
                                    <div class="w-full lg:w-6/12 px-4">
                                        <div class="relative w-full mb-3">
                                            ...
                                            <input type="number" id="kelas" name="kelas" max="12" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">
                                    ...
                                    <div class="w-full lg:w-6/12 px-4">
                                        <div class="relative w-full mb-3">
                                            ...
                                            <div class="flex space-x-4 mt-2">
                                                ...
                                                <label class="inline-flex items-center">
                                                    <input type="radio" id="golongan_darah" name="golongan_darah" value="-" class="form-radio text-pink-500">
...
disabled:pointer-events-none sm:ml-3 sm:w-auto transition">
        ...
        <div id="invalid-modal" class="fixed inset-0 bg-black/30 flex items-center justify-center z-50 hidden transition-opacity duration-300">
            <div class="bg-white rounded-lg shadow-lg p-6 max-w-md w-full">
                ...
                <div class="flex justify-end">
                    <button onclick="hideInvalidModal()" class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded transition-all">
                        Tutup
                    </button>
                </div>
            </div>
        ...
        <div id="alertModal" class="fixed inset-0 z-50 flex items-center justify-center inset-0 bg-black/30 transition-opacity duration-300 opacity-0 pointer-events-none">
            <div id="alertBox" class="bg-white/80 backdrop-blur-md border border-white/30 rounded-lg shadow-xl max-w-sm w-full p-6 scale-95 transition-transform duration-300">
                ...
                <div class="mt-4 flex justify-end">
                    <button onclick="closeAlert()" class="text-sm bg-red-600 hover:bg-red-700 text-white px-6 py-2 rounded transition-all">
                        OK
                    </button>
                </div>
            </div>
    ...
    <script>
        ...
        function openModal() {
            ...
            if (!isDataValid) {
                ...
                // Isi pesan modal
                document.getElementById('invalid-modal-message').textContent =
                    `Data ${invalidFieldsFormatted} wajib diisi!`;
